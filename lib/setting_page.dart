            ...
            Row(
              ...
              children: [
                OutlinedButton.icon(
                  ...
                  onPressed: () async {
                    if (Platform.isIOS) {
                      final url = Uri.parse('https://apps.apple.com/jp/app/id6758260041?action=write-review');
